...
import com.lzc.mobileplayer.view.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    private void showSwichPlayerDialog() {
        ...
        builder.setTitle("提示");
        builder.setMessage("看的不爽？尝试系统播放器？");
    ...
    class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            //1视频的总时间，关联总长度
            int duration = (int) videoview.getDuration();//获得总时长
...
//            });
    ...
    private void showErrorDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("AV出错了");
        builder.setMessage("打击网上淫秽色情内容，保护青少年身心健康!");
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                finish();
